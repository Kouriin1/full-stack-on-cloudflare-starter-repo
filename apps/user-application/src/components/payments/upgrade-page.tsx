...
import { CancelSubscriptionDialog } from "./cancel-susbcription-dialog";
  ...
  const handleUpgrade = async (plan: (typeof plans)[0]) => {
    ...
    try {
      const result = await authClient.subscription.upgrade({
        ...
        returnUrl: `${window.location.origin}/app/upgrate`,
        disableRedirect: false,
        subscriptionId: activeSubscription?.stripeSubscriptionId,
        successUrl: `${window.location.origin}/app/upgrate`,
        cancelUrl: `${window.location.origin}/app/upgrate`,
      });
